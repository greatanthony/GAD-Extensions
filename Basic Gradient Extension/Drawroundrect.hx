...
class Drawroundrect { 
        ...
        public static function draw(g:G, color1:UInt, opacity1:Float, color2:UInt, opacity2:Float, Thickness:Float, Angle:Float, X:Float, Y:Float, Width:Float, Height:Float, Arc:Float) {
